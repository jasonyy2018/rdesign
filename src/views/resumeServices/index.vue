      ...
      <div class="content-top">
        <div class="left-content">
          <div class="left-title">
            <h2 class="title">AI职升姬 1V1 简历优化</h2>
            <p class="desc">
              AI职升姬 核心导师，拥有世界500强企业的工作履历，阅览简历无数，积累了丰富的简历制作、模板设计与定制经验。我们将凭借专业能力，为您提供全方位的简历定制服务，涵盖格式调整、内容精修等，确保为您打造一份契合需求的优质简历。
            </p>
          </div>
          <!-- 查看更多按钮 -->
...
<script setup lang="ts">
  ...
  const services = [
    {
      ...
      title: '简历格式优化',
      content:
        'AI职升姬创始人将从专业角度帮您调整简历格式，包括简历行间距、字体大小等等，让您专注于简历内容的编写，你只需要提供一份您已经编写好的简历，简历必须是在AI职升姬网站上制作的，或者简历已迁移至AI职升姬网站。',
      price: 59
    },
    {
    ...
    },
    {
      ...
      title: '简历定制服务',
      content:
        '从0开始为您制作一份符合岗位需求的专业简历，我们将深度挖掘您的过往经历，结合市场需求，最终给您一份定制化的简历，并且简历可以在AI职升姬网站上持续在线制作修改。',
      price: 229
    }
  ];
  ...
  const advantages = [
    {
      title: '为什么选择 AI职升姬 简历定制服务？',
      content:
        'AI职升姬 导师辅导简历，拥有世界500强企业的工作履历，经验丰富，专业能力有保证。AI职升姬 平台由核心团队全量参与创建，阅览无数简历，深入理解HR认可什么样的简历。相较于其他平台，质量更有保证，辅导人员专业度显而易见。'
    },
    {
      title: '价格公开透明',
      content:
        '相较于市面上的其他平台，AI职升姬 网站的价格公开透明、明码标价、没有私下收费。不同于其他平台的私下询价、不同导师价格差距较大，在这里让你更加省心，也更加放心。'
    },
    {
      title: '官方服务保证',
      content:
        '简历服务由 AI职升姬 官方发起，不用担心多层中间商提成，导致价格与实际服务价值不匹配。最终您支付的价格与服务价值高度匹配。'
    }
  ];
